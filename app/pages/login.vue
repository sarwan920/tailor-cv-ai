  ...
  <div class="min-h-screen w-full flex items-center justify-center p-5 md:p-10 bg-neutral relative">
    <div class="w-full max-w-[440px] z-10">
      <div class="p-8 bg-surface border border-hairline rounded-lg shadow-[rgba(0,0,0,0.04)_0px_4px_12px_0px]">
        ...
        <h1 class="font-sans text-[2rem] font-bold text-primary mb-2 tracking-tight">Sign In</h1>
        <p class="text-[0.82rem] text-secondary leading-normal mb-8">Welcome back. Enter your credentials to access your executive tailoring dashboard.</p>
        ...
        <div class="text-center border-t border-hairline pt-5 mt-8 text-[0.82rem] text-secondary">
          <p>Don't have an account? <NuxtLink to="/signup" class="font-medium text-brand-green hover:text-brand-green-deep transition-colors duration-150 underline underline-offset-[3px]">Create Account</NuxtLink></p>
        </div>
      </div>
    </div>
  </div>
