  ...
  <div class="auth-page dot-matrix-bg fade-in">
    ...
    <div class="auth-container">
      <div class="auth-card glass-panel">
        ...
        <p class="auth-subtitle">Welcome back. Enter your credentials to access your executive tailoring dashboard.</p>
        ...
        <div class="auth-footer">
          <p>Don't have an account? <NuxtLink to="/signup" class="auth-link">Create Account</NuxtLink></p>
        </div>
      </div>
    </div>
  </div>
