  ...
  <div class="min-h-screen w-full flex items-center justify-center p-5 md:p-10 bg-neutral relative dot-matrix-bg">
    ...
    <div class="w-full max-w-[440px] z-10">
      <div class="p-8 bg-surface border border-secondary rounded-lg shadow-[0_12px_40px_rgba(27,25,23,0.05)]">
        ...
        <h1 class="font-serif text-[2.2rem] font-normal text-primary mb-2 tracking-tight">Sign In</h1>
        <p class="text-[0.88rem] text-secondary leading-normal mb-8">Welcome back. Enter your credentials to access your executive tailoring dashboard.</p>
        ...
        <div class="text-center border-t border-secondary/25 pt-5 mt-8 text-[0.82rem] text-secondary">
          <p>Don't have an account? <NuxtLink to="/signup" class="font-medium text-tertiary hover:text-primary transition-colors duration-150 underline underline-offset-[3px]">Create Account</NuxtLink></p>
        </div>
      </div>
    </div>
  </div>
